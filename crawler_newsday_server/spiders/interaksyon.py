...
class InteraksyonSpider(scrapy.Spider):
    name = "interaksyon"
    # allowed_domains = ["interaksyon.philstar.com"]
    # start_urls = ["https://interaksyon.philstar.com"]
    mongo = MongoDB()
        ...
        try:
            ...
            if title and content:
                ...
                try:
                    ...
                    news_content_html = ''
                try:
                    news_category = response.xpath('//meta[@property="article:section"]/@content').get()
                except:
                    news_category = ''
                ...
                item['news_source'] = 'interaksyon'
                item['news_category'] = news_category
